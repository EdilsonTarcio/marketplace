...
class CategoriaSegmentoDataTable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        return (new EloquentDataTable($query))
            ->addColumn('action', function($query){
                $edit = "<a href='".route('categoria-segmento.edit', $query->id)."' class='btn btn-primary mr-2'><i class='far fa-edit'></i></a>";
                $delete = "<a href='".route('categoria-segmento.destroy', $query->id)."' class='btn btn-danger delete-item'><i class='far fa-trash-alt'></i></a>";
            ...
            ->addColumn('subcategoria', function($query){
                return  $query->subcategoria->name;
            })
     ...
     */
    public function query(CategoriaSegmento $model): QueryBuilder
    {
    ...
    public function getColumns(): array
    {
        return [
            ...
            Column::make('categoria')->title('Categoria')->addClass('text-center'),
            Column::make('subcategoria')->title('Subcategoria'),
            Column::make('name')->title('Nome Segmento'),
